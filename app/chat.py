...
company_name = "SalessMindAI"
company_specialization = "Intelligent solutions for businesses"
...
def resume_chat_session(contact_id: str, user_input: str, source, user, followup_stage: str = ""):
    ...
    user_input = user_input + f"<admin>This conversation is taking place on {source} </admin>"
    if followup_stage:
        welcome_message = final_instructions
        messages = []
